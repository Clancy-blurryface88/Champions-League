...
🎯 תחזית
[שורה ראשונה: "[שם נבחרת הבית]: X% | תיקו: X% | [שם נבחרת האורחים]: X%" — השתמש בשמות הנבחרות בפועל, שלושתם יחד שווים 100%]
[שורה שנייה: "תוצאה משוערת: X:X לטובת [שם הנבחרת המנצחת]" — אם תיקו: "תוצאה משוערת: X:X תיקו"]
