              ...
              <motion.div
                ...
                <LiquidGlassCard
                  ...
                  style={{
                    background: isLocked
                      ? 'rgba(10,18,35,0.45)'
                      : 'radial-gradient(ellipse at 15% 20%, rgba(30,136,229,0.45) 0%, transparent 55%), radial-gradient(ellipse at 80% 10%, rgba(251,191,36,0.35) 0%, transparent 45%), rgba(5,10,18,0.75)',
                  }}
                >
                          ...
                          {[
                            ...
                            <React.Fragment key={item.label}>
                              <div className="relative flex flex-col items-center px-3 py-2">
                                <span className="font-extrabold leading-none mb-0.5" style={{ fontSize: "1.05rem", color: '#99f6e4' }}>{item.val}</span>
                                <span className="text-[9px] font-semibold" style={{ color: 'rgba(153,246,228,0.62)' }}>{item.label}</span>
                              </div>
                              {i < 3 && <div className="self-center" style={{ width: 1, height: 24, background: 'rgba(153,246,228,0.16)' }} />}
                            </React.Fragment>
                          ))}
                        </div>
                      }
