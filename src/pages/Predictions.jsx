                      ...
                      >
                        ...
                        <div className="flex justify-center items-center cursor-pointer pt-11"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_a_logo} name={match.team_a} className="w-[85px] h-[85px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
                        ...
                        <div className="flex justify-center items-center cursor-pointer pt-11"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_b_logo} name={match.team_b} className="w-[85px] h-[85px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
