    ...
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8 pb-52">
        ...
        {matches.some((match) => !isMatchLocked(match.match_date)) && (() => {
          ...
          return (
            <div className="fixed bottom-[44px] left-0 right-0 z-40 flex justify-center px-6 pb-3 pt-2 pointer-events-none border-t border-white/[0.07]" style={{ background: 'rgba(5,10,20,0.85)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
