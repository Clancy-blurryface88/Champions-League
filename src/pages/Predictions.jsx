                      ...
                      >
                        ...
                        <div className="flex justify-center items-center cursor-pointer pt-6"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_a_logo} name={match.team_a} className="w-[82px] h-[82px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
                        ...
                        <div className="flex justify-center items-center cursor-pointer pt-6"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_b_logo} name={match.team_b} className="w-[82px] h-[82px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
