                ...
                >
                  ...
                  <CardContent className="p-5 pt-2 flex-1 flex flex-col justify-between">
                    ...
                    <div className="py-3 px-1">
                      ...
                      >
                        {/* Row 1: flags */}
                        <div className="flex justify-center items-center cursor-pointer pt-11"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_a_logo} name={match.team_a} className="w-[100px] h-[100px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
                        ...
                        <div className="flex justify-center items-center cursor-pointer pt-11"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_b_logo} name={match.team_b} className="w-[100px] h-[100px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
