              ...
              <motion.div
                ...
                <LiquidGlassCard
                  ...
                  style={{
                    background: isLocked
                      ? 'rgba(10,18,35,0.45)'
                      : 'radial-gradient(ellipse at 15% 20%, rgba(30,136,229,0.45) 0%, transparent 55%), radial-gradient(ellipse at 85% 80%, rgba(23,173,55,0.4) 0%, transparent 55%), radial-gradient(ellipse at 80% 10%, rgba(251,191,36,0.35) 0%, transparent 45%), rgba(5,10,18,0.75)',
                  }}
                >
