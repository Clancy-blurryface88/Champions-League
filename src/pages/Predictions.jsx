    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 pb-20" style={{ paddingTop: '84px' }}>
        ...
        {expandedDates !== null && sortedDateKeys.length > 0 && (
          <div
            className="sticky top-[65px] z-20 -mx-4 px-4 pt-2 pb-2 mb-2"
            style={{
                  ...
                  <CardContent className="p-5 pt-2 flex-1 flex flex-col justify-between">
                      ...
                      >
                        ...
                        <div className="flex justify-center items-center pt-14"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_a_logo} name={match.team_a} className="w-[77px] h-[77px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
                        ...
                        <div className="flex justify-center items-center pt-14"
                          ...
                          <motion.div
                            ...
                            <TeamFlag logo={match.team_b_logo} name={match.team_b} className="w-[77px] h-[77px]" animate={shouldAnimate} rounded="md" />
                          </motion.div>
                        </div>
                        ...
                        <div style={{ gridColumn: 1, gridRow: 2, alignSelf: 'start' }}
                          ...
                          <span className="text-[10px] font-extrabold leading-none text-center" style={{
                            backgroundImage: 'linear-gradient(135deg, #d1fae5 0%, #6ee7b7 100%)',
                        ...
                        <div style={{ gridColumn: 3, gridRow: 2, alignSelf: 'start' }}
                          ...
                          <span className="text-[10px] font-extrabold leading-none text-center" style={{
                            backgroundImage: 'linear-gradient(135deg, #dbeafe 0%, #7dd3fc 100%)',
                            WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent', WebkitTextFillColor: 'transparent',
                          }}>(Away)</span>
                    ...
                    <div className="pt-3 space-y-1">
                      ...
                      <div className="flex items-center justify-center gap-1.5 text-xs text-white">
                        ...
                        <span className="font-extrabold" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.85), 0 0 1px rgba(0,0,0,0.9)' }}>{moment(match.match_date).format('DD/MM/YYYY')} · {moment(match.match_date).format('HH:mm')}</span>
                      </div>
                      {match.location && (
      ...
      {/* Submit Button — תמיד גלוי, מחוץ לאזור הגלילה */}
      {matches.some((match) => !isMatchLocked(match.match_date)) && (() => {
        ...
        return (
          <div className="absolute bottom-0 left-0 right-0 flex justify-center px-4 py-2 border-t border-white/[0.08] z-20 rounded-t-3xl" style={{ background: 'rgba(10,18,40,0.35)', backdropFilter: 'blur(28px) saturate(1.6)', WebkitBackdropFilter: 'blur(28px) saturate(1.6)' }}>
