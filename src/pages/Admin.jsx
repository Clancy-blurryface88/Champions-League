...
import AdminPredictionDesigns from "../components/admin/AdminPredictionDesigns";
...
export default function Admin() {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'designs': return <AdminPredictionDesigns />;
  ...
  const navItems = [
    ...
    { id: 'designs',  label: '🎨 Design Ideas',   icon: Eye },
  ];
