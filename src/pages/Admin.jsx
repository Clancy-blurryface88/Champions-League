...
import AdminFinalDesigns from "../components/admin/AdminFinalDesigns";
...
export default function Admin() {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'final-designs': return <AdminFinalDesigns />;
  ...
  const navItems = [
    ...
    { id: 'final-designs',    label: '🏆 עיצובי גמר (דמו)',    icon: Sparkles },
  ];
