...
import AdminCarouselDemo from "../components/admin/AdminCarouselDemo";
...
export default function Admin() {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'carousel-demo': return <AdminCarouselDemo />;
  ...
  const navItems = [
    ...
    { id: 'carousel-demo', label: '🎠 Carousel Demo', icon: RotateCcw },
  ];
