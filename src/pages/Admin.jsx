...
import AdminLivePanelDesigns from "../components/admin/AdminLivePanelDesigns";
...
export default function Admin() {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'panel-designs': return <AdminLivePanelDesigns />;
  ...
  const navItems = [
    ...
    { id: 'panel-designs', label: '🎨 Panel Designs', icon: Eye },
  ];
