...
import AdminDramaLeaderboard from "../components/admin/AdminDramaLeaderboard";
...
export default function Admin() {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'drama-lb': return <AdminDramaLeaderboard />;
  ...
  const navItems = [
    ...
    { id: 'drama-lb', label: '🎭 Leaderboard 30', icon: RotateCcw },
  ];
