...
function LiveMatchesChipList({ liveMatches }) {
  return (
    <div className="flex flex-col items-center gap-2" style={{ maxHeight: '80vh', width: '100%', boxSizing: 'border-box', overflowY: 'auto', overflowX: 'visible', pointerEvents: 'auto', padding: 12 }}>
      <AnimatePresence>
        {liveMatches.map((m, i) => (
          <motion.div
            key={m.id}
