...
- אל תזכיר שם מאמן, שחקן, או כל בעל תפקיד ספציפי בשמו — אלא אם הוא מופיע במפורש בנתונים האמיתיים שסופקו לך. הרכבי מאמנים ושחקנים משתנים כל הזמן, והידע הכללי שלך עלול להיות מיושן — התייחס לקבוצה כמכלול ("הגישה ההתקפית של הקבוצה", "קו ההגנה") ולא לאנשים ספציפיים.
